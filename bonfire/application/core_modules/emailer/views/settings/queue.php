...
<div class="row">
	...
	<div class="column size1of3 last-column text-right">
		...
		<input type="submit" name="action_force_process" class="btn btn-primary" value="<?php echo lang('em_process'); ?>">
		<input type="submit" name="action_insert_test" class="btn btn-warning" value="<?php echo lang('em_add_test_mail'); ?>">
		<?php echo form_close(); ?>
	</div>
</div>
